...
const Home = () => {
  ...
  return (
    <section
      id="Home"
      className="min-h-screen flex items-center justify-between px-6 sm:px-10 md:px-20 relative bg-white"
      style={{
    ...
    >
      ...
      <div className="max-w-2xl z-10 text-left space-y-8">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-[#0A1F44]">
          Discover <span className="text-[#4169E1]">Smarter Eye Care</span><br />
